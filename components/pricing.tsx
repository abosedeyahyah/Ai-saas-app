...
export default function Pricing() {
  const plansMap = [{
    name:"Basic",
    describtion:"Get Started With SpeakEasy!",
    price:"10",
    items: ["3 Blog post", "3 Transcription"],
    paymentLink:"https://buy.stripe.com/test_3csaIlacMgGlaHueUU"
  },

  {
    id:"",
    name:"Pro",
    description:"All Blog Post Let Go!!",
    price:"10",
    items: ["3 Blog post", "3 Transcription"],
    paymentLink:"https://buy.stripe.com/test_fZedUx98I4XD2aY3cd",
    priceId: process.env.NODE_ENC === "development"?"price_1PzybT07e9H6fdOVNAmjr668"
    :""
  }
];
  return (
            ...
            <div className="relative w-full max-w-lg" key={idx}>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  >
                    <Link
                      href={"https://buy.stripe.com/test_fZedUx98I4XD2aY3cd"}
